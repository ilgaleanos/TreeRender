                ...
                return(
                        <div class="Main">
                                <div class="Anim">
                                {
                                        this.mData.items.map((item)=>{return(
                                                <div class="AnimBox"
                                                style={ 'border-radius:'+ item.time +'px; background:rgba(0,0,0,'+(0.5 + (( item.time % 10) / 10))+');'} data-id={ item.id }></div>
                                        )})
                                }
                                </div>
                        </div>
                        ...
                        <ul class="TreeNode">
                                {
                                        data.children.map((n)=>{
                                                if ( n.container ) {
                                                        ...
                                                        return( <li class="TreeLeaf">{ n.id }</li>)
                                                }
                                        })
                                }
                        </ul>
